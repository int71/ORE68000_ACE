...
**									I71										**
**																			**
**	'main/base.hpp'									2025 written by int71	**
 ****************************************************************************/
#ifndef I71_MAIN_BASE
#define I71_MAIN_BASE
...
namespace m68k::i71::main{
	...
	static constexpr AUTO	RAM_stcui32iAddress=							ore68000ace::RAM_stcui32iAddressM;
	static constexpr AUTO	RAM_stcui32nSize=								ore68000ace::RAM_stcui32nSizeM;
	...
	//	HID_KEYBOARD_DEVICE
	using					HID_KEYBOARD_DEVICE=							common::KEYBOARD_DEVICE;
	//	HID_JOYSTICK_DEVICE
	using					HID_JOYSTICK_DEVICE=							common::JOYSTICK_DEVICE;
	//	BASE
